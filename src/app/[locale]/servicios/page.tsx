...
import { FeaturesSectionData, Locale } from '@/types';
  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <main className="flex-grow">
        {featuresData ? (
          <FeaturesSection {...getLocalizedContent(featuresData, locale)} items={featuresData.items.map(item => getLocalizedContent(item, locale))} />
        ) : (
